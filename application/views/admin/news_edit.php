	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-9">
				...
				<?php endif; ?>
				<?php echo form_open('admin/news_edit_post', array('class' => 'form-horizontal', 'role' => 'form')); ?>
				<?php echo form_hidden('id', $news_content->id); ?>
					<div class="form-group">
						<?php echo form_label('Title', 'title', array('class' => 'col-md-2 control-label')); ?>
						<div class="col-md-10">
							<?php echo form_input(array('name' => 'title', 'id' => 'title', 'class' => 'form-control', 'value' => $news_content->title, 'placeholder' => 'News Title')); ?>
						</div>
					</div>
					<div class="form-group">
						<?php echo form_label('Content', 'content', array('class' => 'col-md-2 control-label')); ?>
						<div class="col-md-10">
							<?php echo form_textarea(array('name' => 'content', 'id' => 'content', 'class' => 'form-control', 'value' => $news_content->content, 'placeholder' => 'News Content')); ?>
						</div>
					</div>
					<div class="form-group">
