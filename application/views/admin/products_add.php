	...
	<div class="container">
		<div class="row">
			<div class="col-md-3">
				<div class="well well-sm">
					<ul class="nav nav-pills nav-stacked">
						...
						<li class="active"><?php echo anchor('admin/products_add', 'Add Product'); ?></li>
					</ul>
				</div>
			...
			<div class="col-md-9">
				...
				<?php endif; ?>
				<?php echo form_open_multipart('admin/product_post', array('class' => 'form-horizontal', 'role' => 'form')); ?>
					<div class="form-group">
						<?php echo form_label('Product Name', 'name', array('class' => 'col-md-2 control-label')); ?>
						<div class="col-md-10">
							<?php echo form_input(array('name' => 'name', 'id' => 'name', 'class' => 'form-control', 'placeholder' => 'Product Name')); ?>
						</div>
					</div>
					<div class="form-group">
						<?php echo form_label('Product Description', 'description', array('class' => 'col-md-2 control-label')); ?>
						<div class="col-md-10">
							<?php echo form_textarea(array('name' => 'description', 'id' => 'description', 'class' => 'form-control', 'placeholder' => 'Product Description')); ?>
						</div>
					</div>
					<div class="form-group">
						<?php echo form_label('Price', 'price', array('class' => 'col-md-2 control-label')); ?>
						<div class="col-md-10">
							<?php echo form_input(array('name' => 'price', 'id' => 'price', 'class' => 'form-control', 'placeholder' => 'Price')); ?>
						</div>
					</div>
					<div class="form-group">
